...
namespace PatienceShoppingPlatform
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<ShoppingItemsDbContext>(opts => opts.UseSqlServer(Configuration["ConnectionStrings:ItemShoppingDatabase"]));
